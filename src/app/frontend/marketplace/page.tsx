...
const Marketplace = () => {
  ...
  return (
    <div className="font-sans text-gray-900 w-full max-w-none min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section
        className="relative text-center py-16 bg-gray-100 w-full flex items-center justify-center min-h-[260px] md:min-h-[340px] mb-8"
        style={{
      ...
      <section className="p-6 w-full pb-32">
        ...
        {!loading && !error && (
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {products.map((product) => (
              <div key={product.id} className="border p-4 rounded shadow-sm bg-white flex flex-col items-stretch">
                <img
                  src={product.image}
                  alt={product.name}
                ...
                <p
                  className="text-xs whitespace-pre-line overflow-hidden mb-2"
                  style={{
                    display: "block",
                    lineHeight: "1.5",
                    maxHeight: "7.5em",
                ...
                <button
                  className="bg-gray-300 text-black px-4 py-1 rounded mt-auto w-full"
